...
- Branche de développement : `gloss_final`
- Version du plugin : `0.21.3`
- Étape intégrée : G3.5
- Portée : tous les nets du cuivre final
...
Le lancement normal de KRT reste inchangé. Quand la chaîne principale atteint
son résultat final, elle exécute le dernier smooth KRT puis Track Gloss. Les
quatre options suivantes sont visibles dans les options du plugin, activées par
défaut et persistées :
...
À partir de G4, la convention prévue revient à une seule vue finale sur User.1.
